      ...
      <table class="table table-bordered table-condensed">
        ...
        <tbody>
          <tr
            ...
            :key="card._id"
            :class="{ success: selectedIdx == idx }"
          >
            <td>
              <button
                class="btn btn-primary"
                @click="displayDyeCardDetail(card, idx)"
              >
            ...
            <td>
              <button
                class="btn btn-primary"
                @click="displayWorkCards(card, idx)"
              >
...
export default {
  ...
  methods: {
    ...
    displayTime(t) {
      if (t) return moment(t).format('LLL');
      else return '之前未紀錄(新卡都會有)';
    },
